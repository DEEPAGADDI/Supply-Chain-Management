...
public final class paymenttabdistributor_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try{
      ...
      out.write("            ");
             ...
             System.out.print(disid);
             rst=stmt.executeQuery("select * from paybydistributor where confirmpayment='A' and did='"+disid+"' order by payid desc");
             while( rst.next())
             {
